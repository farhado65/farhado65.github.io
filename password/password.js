...
var app = new Vue({
    ...
    methods: {
        evaluateScore: function() {
            // definim nou score initial egal cu 0
            let newScore = 0;
            // evaluam ficare conditie dintre cele 5
            // adaugam 1 la noul score pentru fiecare conditie adevarta:
          ...
          newScore = [
            ...
            this.score = newScore;
            // inlocuim mesajul cu nou mesaj asociat noului scor
